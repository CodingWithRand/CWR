...
export const learningStyle = <>
    ...
    <p>&emsp;&emsp;ChatGPT is very helpful, because it could explain you about the error of the code, which is sometimes hard to understand. It can point out where the error come from accurately, and it can also suggest solutions. But those solutions are not always right, and because some of the require information may be outdated, missing, incorrect or explained confusingly, I have to look up the solution on Stack Overflow, or other programming blogs.</p>
    <p>&emsp;&emsp;So guys, just use it, the AI. We have to be a good prompter. This is one of the skill we need. Or else, even us programmer, our job will be taken away by AI (I&apos;m fear of Devin 😰)</p>
</>